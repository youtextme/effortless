...
Prompt OS 3.3.2 — STATUS LAW (Jillu banner deprecated).

# Devin — Prompt OS 3.3.2

Load before sessions:

1. `kernel/router/PROMPT-ROUTER.md`
2. `kernel/CONSTITUTION.md`
...
Read and obey `kernel/router/PROMPT-ROUTER.md` before substantive work. Improvements happen in the router only.
